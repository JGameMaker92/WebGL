if (!navigator.project) {
    ...
    navigator.project.tagName = "VirtualRiot.babylon.js";
    navigator.project.scenePath = "scenes/";
    navigator.project.scriptPath = "scripts/";
    navigator.project.projectTitle = "Virtual Riot";
    navigator.project.defaultScene = "SampleScene.babylon";
    ...
    navigator.project._scriptLibraries.push("scenes/VirtualRiot.babylon.js");
    navigator.project._loadProjectScripts(navigator.project._scriptLibraries, 0, "VirtualRiot.babylon");
} else {
